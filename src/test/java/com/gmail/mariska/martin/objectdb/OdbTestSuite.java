package com.gmail.mariska.martin.objectdb;
...
public abstract class OdbTestSuite {
    private static final String ODB_TEST_FILE = "objectdb:myDbFile.tmp;drop";
    ...
    public static void setUp() {
        ...
        emf = Persistence.createEntityManagerFactory(ODB_TEST_FILE); // ;drop
    }
