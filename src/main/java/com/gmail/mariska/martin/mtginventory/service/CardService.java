...
public class CardService extends AbstractService<Card> {
    ...
    public CardService(EntityManager em, EventBus eventBus, WebPageSnifferService sniffer, IDao<Card> dao, IDao<BannedCardNames> bannedCardsDao) {
        super(em, dao);
    ...
    /**
     * Ulozi DCI do databaze a zaroven i karty
