...
public enum CardEdition {
    ...
    DD_KNIGHTS_VS_DRAGONS("DDKvD", "DD: Knights vs Dragons", "DD: Knights vs. Dragons", "Duel Decks: Knights vs. Dragons"),
    ...
    PD_FIRE_AND_LIGHTNING("PDL", "PD: Fire and Lightning", "Premium Deck Series: Fire and Lightning"),
    PD_GRAVEBORN("PDG", "PD: Graveborn"),
    PD_SLIVERS("PDS", "PD: Slivers", "Premium Deck Series: Slivers"),
